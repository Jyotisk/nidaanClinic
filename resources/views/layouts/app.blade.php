            ...
            <ul class="nav nav-secondary">
              <li class="nav-item {{ Route::is('dashboard') ? 'active' : '' }}">
                <a
                  ...
                  href="#dashboard"
                  class="{{ Route::is('dashboard') ? '' : 'collapsed' }}"
                  aria-expanded="false"
                >
                ...
                <div class="collapse {{ Route::is('dashboard') ? 'show' : '' }}" id="dashboard">
              ...
              <li class="nav-section">
                ...
                <h4 class="text-section">Admin Settings</h4>
              </li>
              <li class="nav-item {{ Route::is('getRole') ? 'active' : '' }}">
                <a data-bs-toggle="collapse" href="#base">
                  <i class="fas fa-layer-group"></i>
                  <p>Roles and Permissions</p>
                  <span class="caret"></span>
                </a>
                <div class="collapse {{ Route::is('getRole') || Route::is('getAssignRole') || Route::is('getAssignPermission')  ? 'show' : '' }}" id="base">
                  <ul class="nav nav-collapse">
                    <li class="{{ Route::is('getRole') ? 'active' : '' }}">
                      <a href="{{route('getRole')}}">
                        <span class="sub-item">Add Role & Permissions</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('getAssignRole')}}">
                        <span class="sub-item">Assign Role</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('getAssignPermission')}}">
                        <span class="sub-item">Assign Permissions</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('GetMenuItems')}}">
                        <span class="sub-item">Menu Items</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('GetMenuSubItems')}}">
                        <span class="sub-item">Menu Sub Items</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('GetMenuISubtemList')}}">
                        <span class="sub-item">Edi Sub Menu Item</span>
                      </a>
                    </li>
                  </ul>
                </div>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            <div class="copyright">
              ...
              <a href="https://cybernetssolutions.com/" target="_blank">Cybernet Solutions</a>
            </div>
