<x-guest-layout>
        ...
        <section class="main-slider-one">
            <div class="main-slider-one__carousel mediox-owl__carousel mediox-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{ "items": 1, "margin": 0, "animateIn": "fadeIn", "animateOut": "fadeOut", "loop": true,  "smartSpeed": 700,  "nav": false,  "dots": false,  "autoplay": true,  "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow-right\"></span>"] }'>
                ...
                <div class="main-slider-one__item">
                        ...
                        <div class="row gutter-y-60">
                            <div class="col-xl-9">
                                <div class="main-slider-one__content">
                                    ...
                                    <h2 class="main-slider-one__title">
                                        <span class="main-slider-one__title__inner">
                                            ...
                                            <span class="main-slider-one__title__image">
                                                <a href="https://www.youtube.com/watch?v=h9MbznbxlLc" class="main-slider-one__title__video video-btn video-popup">
                                                    <i class="icon-play"></i>
                                            ...
                                            <span class="main-slider-one__title__hover">
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--1"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--2"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--3"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--4"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--5"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--6"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--7"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--8"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--9"></span>
                                                <span class="main-slider-one__title__hover__box main-slider-one__title__hover__box--10"></span>
                                            </span><!-- /.main-slider-one__title__hover -->
                                        </span>
                                    </h2><!-- /.title -->
                                    <div class="main-slider-one__description">
                                        <p class="main-slider-one__text">From annual physicals to lab work and vaccinations, and all steps in between, Vivo Clinic patients can get all their needs cared for in one convenient</p><!-- /.text -->
                                    </div><!-- /.description -->
                                    ...
                                    <img src="{{asset('images/shapes/main-slider-shape-1-2.png')}}" alt="shape" class="main-slider-one__content__shape-1">
                                    <img src="{{asset('images/shapes/main-slider-shape-1-3.png')}}" alt="shape" class="main-slider-one__content__shape-2">
                    ...
                    <img src="{{asset('images/shapes/main-slider-shape-1-4.png')}}" alt="shape" class="main-slider-one__shape-2">
                        ...
                        <div class="row gutter-y-60">
                            <div class="col-xl-9">
                                <div class="main-slider-one__content">
                                    ...
                                    <div class="main-slider-one__description">
                                        <p class="main-slider-one__text">Nail it down come up with something buzzworthy going forward c-suite. Hire the best. We need to socialize the comms with the wider stakeholder</p><!-- /.text -->
                                    </div><!-- /.description -->
                                    <div class="main-slider-one__button">
                                        <div class="main-slider-one__button__inner">
                                            <a href="services.html" class="main-slider-one__btn mediox-btn">
                ...
                <div class="row gutter-y-60 align-items-center">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-duration="1500ms">
                        <div class="about-one__image">
                            ...
                            <div class="about-one__experience" style="background-image: url('images/about/about-1-2.jpg');">
                                <div class="about-one__experience__content">
                                    <h3 class="about-one__experience__year">25+</h3>
                                    <span class="about-one__experience__text">Experience in <br> Medical <br> Service</span>
                        ...
                        <div class="about-one__content">
                            <div class="sec-title @@extraClassName wow fadeInUp" data-wow-duration="1500ms">
                                <div class="sec-title__top">
                                    ...
                                    <img src="{{asset('images/shapes/sec-title-s-1-1.png')}}" alt="about us" class="sec-title__img">
            ...
            <div class="container">
                <div class="sec-title sec-title--center wow fadeInUp" data-wow-duration="1500ms">
                    <div class="sec-title__top">
                        ...
                        <img src="{{asset('images/shapes/sec-title-s-1-2.png')}}" alt="our services" class="sec-title__img">
                ...
                <div class="services-one__carousel mediox-owl__carousel mediox-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{ "items": 1, "margin": 10, "loop": true, "smartSpeed": 700, "nav": false, "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow-right\"></span>"], "dots": true, "autoplay": true, "responsive": { "0": { "items": 1, "nav": true, "dots": false, "margin": 10 }, "768": { "items": 2, "margin": 30 }, "992": { "items": 3, "margin": 30 } } }'>
                        ...
                        <div class="service-card">
                            ...
                            <div class="service-card__content">
                                ...
                                <div class="service-card__content__inner">
                                    <h3 class="service-card__title"><a href="service-d-immediate-care.html">immediate care</a></h3><!-- /.service-card__title -->
        ...
        <section class="welcome-one section-space-top">
            <div class="container">
                <div class="welcome-one__inner">
                    <div class="welcome-one__inner__bg" style="background-image: url('images/shapes/welcome-inner-bg-1-1.jpg');"></div>
                    <div class="welcome-one__content">
                        <div class="sec-title @@extraClassName wow fadeInUp" data-wow-duration="1500ms">
                            <div class="sec-title__top">

                                <img src="{{asset('images/shapes/sec-title-s-1-2.png')}}" alt="welcome new patient’s" class="sec-title__img">
                    ...
                    <div class="welcome-one__image">
                        <div class="welcome-one__image__bg" style="background-image: url('images/resources/welcome-1-1.jpg');"></div>
        ...
        <section class="why-choose-one section-space-two">
                ...
                <div class="row guter-y-60">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-duration="1500ms">
                        <div class="why-choose-one__image">
                            <img src="{{asset('images/why-choose/why-choose-1-1.jpg')}}" alt="why choose" class="why-choose-one__image__one">
                        ...
                        <div class="why-choose-one__content">
                            <div class="sec-title @@extraClassName wow fadeInUp" data-wow-duration="1500ms">
                                <div class="sec-title__top">
                                    ...
                                    <img src="{{asset('images/shapes/sec-title-s-1-1.png')}}" alt="why choose us" class="sec-title__img">
            ...
            <img src="{{asset('images/shapes/why-choose-shape-1-1.png')}}" alt="shape" class="why-choose-one__shape-5">
        </section><!-- /.why-choose-one section-space-two -->
        {{-- End of Why Choose Us --}}

        {{-- Funfact Section --}}
        <section class="funfact-one">
            <div class="funfact-one__bg" style="background-image: url(images/resources/funfact-bg-1-1.jpg);"></div><!-- /.funfact-one__bg -->
            <div class="container">
                        ...
                        <div class="skills-one__content">
                            <div class="sec-title @@extraClassName wow fadeInUp" data-wow-duration="1500ms">
                                <div class="sec-title__top">
                                    ...
                                    <img src="{{asset('images/shapes/sec-title-s-1-1.png')}}" alt="we are skillful health care" class="sec-title__img">
        ...
        <section class="team-one">
            <div class="team-one__bg" style="background-image: url('images/backgrounds/team-bg-1-1.jpg');"></div><!-- /.team-one__bg -->
            <div class="container">
                <div class="row gutter-y-50">
                    <div class="col-lg-6 order-1 order-lg-0">
                        <div class="team-one__carousel mediox-owl__carousel mediox-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
                    "items": 1,
                    "margin": 10,
                    "loop": true,
                    "rtl": true,
                        ...
                        "1700": {
                            ...
                            <div class="item">
                                <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                    <img src="{{asset('images/team/team-1-1.jpg')}}" alt="Sarah Albert" class="team-card__image">
                                    <div class="team-card__identity">
                                        <h3 class="team-card__name"><a href="team-details.html">Sarah Albert</a></h3>
                        ...
                        <div class="team-one__content">
                            <div class="sec-title @@extraClassName wow fadeInUp" data-wow-duration="1500ms">
                                <div class="sec-title__top">
                                    ...
                                    <img src="{{asset('images/shapes/sec-title-s-1-1.png')}}" alt="our expert team" class="sec-title__img">
                            ...
                            <div class="team-one__inner wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <p class="team-one__inner__text">Nail it down come up with something buzzworthy going forward c-suite. Hire the best. We need to socialize the comms with the wider.</p>
                            </div><!-- /.team-one__inner -->
